...
export interface ApiCandidatoCandidato extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    attitudiniCandidato: Schema.Attribute.Text;
    ...
    interessiCandidato: Schema.Attribute.Text;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiCurriculumCurriculum extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dataCaricamento: Schema.Attribute.Date;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::curriculum.curriculum'
    > &
      Schema.Attribute.Private;
    percorsoFile: Schema.Attribute.Media<
...
export interface ApiOffertaLavorativaOffertaLavorativa
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    aziendas: Schema.Attribute.Relation<'oneToMany', 'api::azienda.azienda'>;
    candidaturas: Schema.Attribute.Relation<
      'oneToMany',
      'api::candidatura.candidatura'
    >;
    competenzeRichieste: Schema.Attribute.RichText;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dataPubblicazione: Schema.Attribute.DateTime;
    dataScadenza: Schema.Attribute.DateTime;
    descrizioneOffertaLavorativa: Schema.Attribute.Text;
    livelloEsperienza: Schema.Attribute.Enumeration<
      ['entry_level', 'junior', 'middle', 'senior']
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
